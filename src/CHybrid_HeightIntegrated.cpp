...
short num_nds_uniform[3] = {static_cast<short>(RB_X*(BlkNds_X-2)*pow(2,MAX_LEVEL)),
	static_cast<short>(RB_Y*(BlkNds_Y-2)*pow(2,MAX_LEVEL)),
	static_cast<short>(RB_Z*(BlkNds_Z-2)*pow(2,MAX_LEVEL))};
