...
// 	bool package_received[2];
	...
	void calc_CFBG_Vector_with_Parameters(D_REAL* Vector, const D_REAL* moment, const D_REAL* angle, const D_REAL* offset, D_REAL* position);
	...
	//!-------------------------------------------------------------//
        ...
        void calc_en_inelastic_collision_rate(INT32 dest, INT32 electronTemp);
	
	void init_blk_origin(void);
	void init_blk_boundaries(void);

	void init_Eta_Profile(void);
	D_REAL Eta_tanh(D_REAL r, D_REAL R[], D_REAL eta[], D_REAL alpha[]);
...
// 	void count_flagged_nodes(INT32 src_type, F_REAL *max_Value, INT32* num_flagged_nodes);
	...
	void LF_Pe_Step_conservative_CFBG_BField( INT32 PE_to_update,
        ...
        void apply_Gravitation(PARTICLE_REAL *r1, PARTICLE_REAL *r2, D_REAL gM, PARTICLE_REAL *v, D_REAL dt_particle);
        //void apply_Gravitation(PARTICLE_REAL *r, PARTICLE_REAL *v, D_REAL dt_particle);
        void apply_RotationEffects(PARTICLE_REAL *r, PARTICLE_REAL *w, PARTICLE_REAL *v, D_REAL dt_particle);
...
// 	void add_inject_GC_to_parent(INT32 parent_type, INT32 child_type);
	...
	void delete_too_lightweight_particles(INT64* num_too_lightweight_particles, INT32 level);
