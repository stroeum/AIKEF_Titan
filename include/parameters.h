/*! @file
 * Header file for main AIKEF Parameter file.
 *
 * All variables used in parameters.cpp must also be defined here with a leading 'extern const' 
 *
 */
...
extern const D_REAL G;
extern const D_REAL mass_electron_norm;

extern const D_REAL R_Sun;
extern const D_REAL M_Sun; 
extern const D_REAL T_Sun;

extern const D_REAL R_Jupiter;
extern const D_REAL M_Jupiter;
extern const D_REAL T_Jupiter;

extern const D_REAL R_HD179949;
extern const D_REAL M_HD179949;

extern const D_REAL a_HD179949b;
extern const D_REAL R_HD179949b;
extern const D_REAL M_HD179949b;
extern const D_REAL T_HD179949b;
...
extern const D_REAL SI_p0;
extern const D_REAL SI_t0;
extern const D_REAL SI_a0;
...
//!-------------- Frame Parameters -----------------------------//
//!-------------------------------------------------------------//
extern D_REAL O_Frame[3];
extern D_REAL w_Frame[3];
...
extern const bool extended_upstream_boundary_conditions;
...
extern const bool use_Star;

extern const D_REAL R_Star;
extern const D_REAL M_Star; 
extern const D_REAL Position_Star[3]; 
extern const bool use_synced_rot;
extern D_REAL w_Star[3];

extern const D_REAL Magnetic_Moment_Star[3];
extern const D_REAL Magnetic_Moment_Angle_Star[2];
extern const D_REAL Magnetic_Moment_Offset_Star[3];

//! Solar Wind Plasma Velocity
extern const D_REAL V_sw[3];
extern const D_REAL V_esc;
...
extern const bool write_output_if_tofast;
...
extern const bool write_hdf_state;
extern const bool read_hdf_state;
...
extern const bool run_delete_too_light_Particles;
...
extern const bool en_use_inelastic_collisions;
extern const D_REAL en_in_coll_delta_t;
extern const INT32 en_water_neutral_species;
...
extern const D_REAL min_particle_weight;
...
extern const bool use_1st_MP_as_tracer;
