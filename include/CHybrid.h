...
void read_extern_Profile_uniform_grid(INT32 neutralSpec, INT32 id_densityfield, INT32 id_velocityfield, INT32 type_to_read);
...
void delete_too_lightweight_particles();
...
void calc_en_inelastic_collision_rate();

//!-------------------------------------------------------------//
//!--------- extended upstream boundary conditions -----------//
//!-------------------------------------------------------------//
void init_extended_upstream_boundary_conditions(void);
void delete_extended_upstream_boundary_conditions(void);
D_REAL eubc_mean_neutral_mass;
D_REAL eubc_calc_mass_picked_up(D_REAL xmax, D_REAL xmin, gsl_function *F);
void eubc_calc_massloading_flammer(D_REAL mass_picked_up,D_REAL &velocity,D_REAL &massdensity,D_REAL &pressure, D_REAL &magnetic_field);

void eubc_calc_numberdensities(D_REAL &n_sw, D_REAL &n_ci, D_REAL &velocity, D_REAL &rho, D_REAL &magnetic_field);
...
void old_save_state(void);
bool old_restore_state(void);
...
void hdf_save_state(void);
bool hdf_restore_state(void);

void hdf_write_BlockFile(void);
void hdf_write_Field3D(INT32 type);
void hdf_write_Particle();

bool hdf_read_BlockFile(void);
void hdf_read_Field3D(INT32 FType, INT32 restorer_mpi_process);
void hdf_read_Particle(INT32 restorer_mpi_process);
